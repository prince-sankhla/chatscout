...
export default async function CommunityPage({ params }: PageProps) {
  ...
  return <PageShell><main className="page-content detail-page">
    ...
    <CommunityDetailTrust memberCount={communityRow.member_count ?? null} language={communityRow.language ?? null} region={communityRow.region ?? null} ageRestriction={communityRow.age_restriction ?? null} eligibility={communityRow.eligibility ?? null} rules={communityRow.community_rules ?? null} restrictions={communityRow.restrictions ?? null} verificationStatus={communityRow.verification_status ?? "unverified"} healthLabel={community.healthLabel} lastVerifiedAt={communityRow.last_verified_at ?? null} />
